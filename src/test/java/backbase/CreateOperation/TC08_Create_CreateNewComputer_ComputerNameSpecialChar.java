 ...
 *		a) A new computer is created with just computer name as its the only mandatory field(computer name contains special char)
...
public class TC08_Create_CreateNewComputer_ComputerNameSpecialChar extends BaseClass {

	
	
	@Test
	public void TC08_Create_CreateNewComputer_ComputerNameSpecialChar() throws InterruptedException, IOException 
	{
